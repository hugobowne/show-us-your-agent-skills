...
> **Project:** [`heredotnow/skill`](https://github.com/heredotnow/skill), the here.now service's public agent skill.
>
> **License:** MIT, as declared in the [upstream `README.md`](https://github.com/heredotnow/skill). The upstream repository ships no separate `LICENSE` file, so none is vendored here.
>
> **Snapshot:** Frozen copy of [`heredotnow/skill/here-now`](https://github.com/heredotnow/skill/tree/main/here-now) as of 2026-05-22. The maintained version lives upstream and may have evolved since this snapshot.
