...
- **Readwise vault copies** (under `5 - Sources/Readwise/`): The top of the file carries structured metadata (`Author:`, `Title:`, `Source URL(s):`, `Date:`). Head sampling captures that plus the top highlights, which is nearly always enough.
