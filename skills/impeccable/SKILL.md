...
> **Project:** [pbakaus/impeccable](https://github.com/pbakaus/impeccable). "The design language that makes your AI harness better at design."
>
> **License:** [Apache License 2.0](https://github.com/pbakaus/impeccable/blob/main/LICENSE). Full license text is in [`LICENSE`](LICENSE) alongside this file. Impeccable builds on Anthropic's `frontend-design` skill; that attribution is in [`NOTICE.md`](NOTICE.md).
>
> **Snapshot:** Frozen copy of [`pbakaus/impeccable/.agents/skills/impeccable`](https://github.com/pbakaus/impeccable/tree/main/.agents/skills/impeccable) as of 2026-05-22. The maintained version lives upstream and may have evolved since this snapshot. Script paths inside this file (`.agents/skills/impeccable/scripts/...`) are upstream-relative and left unedited; adjust them to wherever you install the folder.
>
> **Modification notice:** This file has been changed from the upstream original. The change is the addition of this blockquote header; the skill content below it is unmodified.
