...
> **Project:** [specstoryai/getspecstory / `lore`](https://github.com/specstoryai/getspecstory/tree/dev/lore). "SpecStory Lore - mine your coding histories into a corpus; forge your workflows into skills."
>
> **License:** [Apache License 2.0](https://github.com/specstoryai/getspecstory/blob/dev/lore/LICENSE). Full license text is in [`LICENSE`](LICENSE) alongside this file.
>
> **Snapshot:** Frozen copy of [`specstoryai/getspecstory/lore`](https://github.com/specstoryai/getspecstory/tree/dev/lore) as of 2026-07-18. The maintained version lives upstream and may have evolved since this snapshot.
