...
> **Project:** [`intellectronica/agent-skills`](https://github.com/intellectronica/agent-skills), Eleanor Berger's agent skills collection.
>
> **License:** [CC0 1.0 Universal](https://github.com/intellectronica/agent-skills/blob/main/LICENSE.txt) (public domain dedication). Full license text is in [`LICENSE`](LICENSE) alongside this file.
>
> **Snapshot:** Frozen copy of [`intellectronica/agent-skills/skills/anki-connect`](https://github.com/intellectronica/agent-skills/tree/main/skills/anki-connect) as of 2026-05-22. The maintained version lives upstream and may have evolved since this snapshot.
