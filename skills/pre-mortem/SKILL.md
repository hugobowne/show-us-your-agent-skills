...
>
> **Snapshot:** Frozen copy of [`pre-mortem.md.txt`](https://github.com/honnibal/claude-skills/blob/main/pre-mortem.md.txt) as of 2026-05-22. The maintained version lives upstream and may have evolved since this snapshot.
